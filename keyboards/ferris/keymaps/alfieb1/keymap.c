...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|-------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+
        KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                         KC_H,    KC_J,    KC_K,    KC_L, LT3SCLN,
  //|-------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+
        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                         KC_N,    KC_M, LALTCOM,  KC_DOT, LGUISLH,
  //|-------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+
                                         KC_LCTL, KC_LSFT,     KC_SPC,  TO(1) 
                                      //-----------------'  `------------------
  ),

  [1] = LAYOUT(
  //,-------------------------------------------.                    ,---------------------------------------------
     KC_EXLM, KC_DQUO, KC_LCBR, KC_RCBR, KC_PIPE,                      XXXXXXX, KC_CIRC, KC_MINS, KC_QUOT, XXXXXXX,
  //|-------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+
     KC_NUHS,  KC_DLR, KC_LPRN, KC_RPRN,   SNUBS,                      KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, XXXXXXX,
  //|-------+--------+--------+--------+--------j                    |--------+--------+--------+--------+--------+
     KC_PERC, KC_HASH, KC_LBRC, KC_RBRC, KC_AMPR,                      XXXXXXX,  KC_EQL, KC_UNDS,   KC_AT, XXXXXXX,
  //|-------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+
                                           TO(0), KC_LSFT,    XXXXXXX,    TO(2)
                                      //-----------------'  `------------------
  ),

  [2] = LAYOUT(
  //,-------------------------------------------.                    ,---------------------------------------------
      KC_F12,  KC_F11,  KC_F10,   KC_F9, KC_LGUI,                      XXXXXXX,    KC_7,    KC_8,    KC_9, KC_PAST,
  //|-------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+
       KC_F8,   KC_F7,   KC_F6,   KC_F5,   WVD_U,                       KC_DOT,    KC_4,    KC_5,    KC_6, KC_PPLS,
  //|-------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+
       KC_F4,   KC_F3,   KC_F2,   KC_F1,   WVD_D,                         KC_0,    KC_1,    KC_2,    KC_3, KC_PMNS,
  //|-------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+
                                           TO(0), KC_LSFT,    KC_LGUI,    TO(3)
                                      //-----------------'  `------------------
  ),

  [3] = LAYOUT(
  //,-------------------------------------------.                    ,---------------------------------------------
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      XXXXXXX, KC_LALT, KC_LSFT, KC_LCTL,   MO(4),
  //|-------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+
     XXXXXXX, KC_BTN2, KC_BTN3, KC_BTN1, XXXXXXX,                      KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, XXXXXXX,
  //|-------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+
