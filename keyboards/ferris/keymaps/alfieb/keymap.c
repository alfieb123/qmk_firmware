...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT(
  //,-------------------------------------------.                    ,---------------------------------------------
      KC_F12,  KC_F11,  KC_F10,   KC_F9, WVD_NXT,                       KC_EQL,    KC_7,    KC_8,    KC_9, KC_PAST,
  //|-------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+
     GUI__F8, ALT__F7, CTL__F6, SFT__F5, WVD_PRV,                       KC_DOT, SFT_NU4, CTL_NU5, ALT_NU6, GUI_PLS,
  //|-------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+
       KC_F4,   KC_F3,   KC_F2,   KC_F1,     GAS,                         KC_0,    KC_1,    KC_2,    KC_3, KC_PMNS,
  //|-------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+
